        ...
        <section id='pricing' className='bg-header relative py-20'>
            ...
            <div className='container px-4'>
                <h3 className='text-center text-4xl sm:text-65xl font-black'>
                    Choose Your PayFlow Plan.
                </h3>

                <p className='text-lg font-normal text-center text-black/60 pt-5'>
                    Select the perfect plan for your business needs. Start with our free trial
                    <br /> and upgrade as you grow. All plans include our core payment management features.
                </p>
