            ...
            <div id='version' className='md:scroll-m-[180px] scroll-m-28'>
                ...
                <div className='mt-5'>
                    <p className='text-base font-medium text-muted text-opacity-60'>
                        PayFlow Tailwind NextJs Template is built with Tailwindcss and
                        Nextjs.
                    </p>
                    <p className='text-base font-medium text-muted text-opacity-60'>
                        This theme is ready to use and you can totally customize as per
                        your requirement.
                    </p>
                    <p className='text-base font-medium text-muted text-opacity-60'>
                        For customization, you should have knowledge of NextJs, ReactJs,
                        Tailwind and JSX to be able to modify this template.
                    </p>
                </div>
            </div>
